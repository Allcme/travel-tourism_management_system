...
public class Destinations extends JFrame implements Runnable{
	...
	Thread t1; //used for runnable

	//objects created for 10 images to slideshow
	JLabel l1, l2, l3, l4, l5, l6, l7, l8, l9, l10;
	JLabel[] label = new JLabel[]{l1, l2, l3, l4, l5, l6, l7, l8, l9, l10};
	//JLabel caption;
	
	//used for slideshow functionality to show the images
	public void run() { //for runnable
		
		/*String[] text = new String[] {"JW Marriott Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", 
		...
		*/
		try {
			for (int i = 0; i<=9; i++) {
				...
				Thread.sleep(2500);  //for seconds u need to stop or show
	...
	Destinations() {
		...
		//objects created for 9 images to slideshow
		for(int i = 0; i<=9; i++) {
